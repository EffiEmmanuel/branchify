...
export default function Home() {
  ...
  useEffect(() => {
    console.log("LSR:", locomotiveScrollRef);
    console.log("LSP:", LocomotiveScrollProvider);
  }, [locomotiveScrollRef]);
      ...
      <div data-scroll-container ref={locomotiveScrollRef}>
        ...
        >
          ...
          <h1
            ...
            data-scroll-speed="9"
          >
            Hello world my name is Effi Emmanuel
          </h1>
          ...
          <section
            className="mt-32 min-h-screen flex flex-col-reverse lg:flex-row md:justify-between"
            data-scroll-section
          >
